...
local suspended_jobs='%{$fg[magenta]%}%(1j.%j .)%{$reset_color%}'
local remote_user_host='%{$fg[green]%}${SSH_TTY:%n@%m ]}%{$reset_color%}'
...
export PROMPT="${the_time}${suspended_jobs}${remote_user_host}${ruby_version}
