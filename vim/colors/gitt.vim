" Vim color file
"
" Heavily Edited By: Jared Norman <hi@jarednorman.ca>
" Original Author: Anthony Carapetis <anthony.carapetis@gmail.com>
" Original: https://github.com/acarapetis/vim-github-theme/blob/master/github.vim
...
hi StatusLineNC guibg=#bbbbbb guifg=#404040 gui=none
hi ColorColumn  guibg=#D8D8DD
" }}}
...
" {{{ Tabs (non-gui0
hi TabLine		guifg=#404040 guibg=#bbbbbb gui=none
hi TabLineFill	guifg=#404040 guibg=#bbbbbb gui=none
