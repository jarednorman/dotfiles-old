...
" Normal mode
let s:N1 = [1, 1, 'black', 4]
let s:N2 = [1, 1, 14, 'black']
let s:N3 = [1, 1, 10, 'black']

" Insert mode
let s:I1 = [1, 1, 'black', 6]
let s:I2 = [1, 1, 14, 'black']
let s:I3 = [1, 1, 10, 'black']

" Visual mode
let s:V1 = [1, 1, 'black', 5]
let s:V2 = [1, 1, 14, 'black']
let s:V3 = [1, 1, 10, 'black']

" Replace mode
let s:R1 = [1, 1, 'black', 1]
let s:R2 = [1, 1, 14, 'black']
let s:R3 = [1, 1, 10, 'black']
...
" Inactive mode
let s:IA1 = [1, 1, 'black', 'black', '']
let s:IA2 = [1, 1, 'black', 'black', '']
let s:IA3 = [1, 1, 'black', 'black', '']
