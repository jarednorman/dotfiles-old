...
let s:p.insert.left = [ [ s:base02, s:cyan ], [ s:base02, s:base2 ] ]
let s:p.replace.left = [ [ s:base02, s:yellow ], [ s:base02, s:base2 ] ]
let s:p.visual.left = [ [ s:base02, s:orange ], [ s:base02, s:base2 ] ]
